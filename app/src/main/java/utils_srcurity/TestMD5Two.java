...
public class TestMD5Two {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String basePath = "/Users/xu.yu/Downloads/bb/";
        File file = new File(basePath+ "insert/12345.txt");
        String md5 = getFileMD5String(file);

        //文件名不同，内容相同；
        File file2 = new File(basePath+ "insert/12345(2).txt");
        String md52= getFileMD5String(file2);


        //文件名不同，内容不同；
        File file3 = new File(basePath+ "insert/12345(3).txt");
        String md53= getFileMD5String(file3);


        //测试压缩包
        File fileZip = new File(basePath+ "insert/1.zip");
        String md5Zip= getFileMD5String(fileZip);

        //测试压缩包
        File fileZip2 = new File(basePath+ "insert/2.zip");
        ...
        System.out.println("md5:" + md5 + " time:" + (System.currentTimeMillis() - begin)  + "ms");
    }
